...
class BitcoinClient {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info(`Checking if bitcoin contains a wallet for ${walletAddress}`);
            if (!(yield this.isAddressAddedToWallet(walletAddress.toString()))) {
                Logger_1.default.info(`Configuring bitcoin peer to watch address ${walletAddress}. This can take up to 10 minutes.`);
    ...
    rpcCall(request, timeout, isWalletRpc) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.default.info(`Sending jRPC request: id: ${request.id}, method: ${request.method}`);
