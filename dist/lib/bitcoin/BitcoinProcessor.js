        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const block of blocks) {
                if (block.height >= startingBlockHeight && block.height <= heightOfEarliestKnownValidBlock) {
                    notYetValidatedBlocks.set(block.hash, {
                        height: block.height,
                        hash: block.hash,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let transactionIndex = 0; transactionIndex < transactions.length; transactionIndex++) {
                ...
                try {
                    ...
                    Logger_1.default.info(`An error happened when trying to add sidetree transaction to the store. Moving on to the next transaction. Inputs: ${JSON.stringify(inputs)}\r\n` +
